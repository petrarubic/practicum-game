...
namespace VHS
{
    ...
    {
        #region Variables
        public bool applyToVirtualCam;
        [ShowIf("applyToVirtualCam")] public CinemachineVirtualCamera cinemachineVirtualCamera;
                    ...
                    case TransformTarget.Position:
                        {
                            ...
                            {
                                m_finalPos.x = x ? _posOffset.x : cinemachineVirtualCamera.gameObject.transform.localPosition.x;
                                m_finalPos.y = y ? _posOffset.y : cinemachineVirtualCamera.gameObject.transform.localPosition.y;
                                m_finalPos.z = z ? _posOffset.z : cinemachineVirtualCamera.gameObject.transform.localPosition.z;
                                cinemachineVirtualCamera.gameObject.transform.localPosition = m_finalPos;
                            }
                    ...
                    case TransformTarget.Rotation:
                        {
                            ...
                            {
                                m_finalRot.x = x ? _rotOffset.x : cinemachineVirtualCamera.gameObject.transform.localEulerAngles.x;
                                m_finalRot.y = y ? _rotOffset.y : cinemachineVirtualCamera.gameObject.transform.localEulerAngles.y;
                                m_finalRot.z = z ? _rotOffset.z : cinemachineVirtualCamera.gameObject.transform.localEulerAngles.z;

                                cinemachineVirtualCamera.gameObject.transform.localEulerAngles = m_finalRot;
                            }
